...
#define _QWERTY_NUMBERS_15_GINKGO_         KC_ESC,  _NUMBERS_, KC_MINS, KC_EQL,  KC_BSPC, KC_GRV
...
#define _QWERTY_ALPHAS1_15_GINKGO_         _QWERTY_ALPHAS1_14_, KC_DEL
...
#define _ADJUST_NUMBERS_15_GINKGO_         _ADJUST_NUMBERS_14_, _______
