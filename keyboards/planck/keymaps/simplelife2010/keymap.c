 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  |A/Ctrl|S/Alt |D/GUI |F/Sft |   G  |   H  |J/Sft |K/GUI |L/Alt |;/Ctrl|Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, KC_VOLD, KC_BRID, _______, KC_MUTE,    _______,    _______, _______, _______,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, KC_VOLU, KC_BRIU, _______, KC_MUTE, _______, _______, _______, _______,
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______,  KC_F11,  KC_F11,  _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______
)
